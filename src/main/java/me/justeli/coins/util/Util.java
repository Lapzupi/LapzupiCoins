...
public final class Util {
    ...
    public static Player getOnlinePlayer(String incomplete) {
        for (Player player : Bukkit.getServer().getOnlinePlayers()) {
            if (player.getName().toLowerCase().startsWith(incomplete.toLowerCase()) ||
                player.getDisplayName().toLowerCase().contains(incomplete.toLowerCase()) ||
                player.getName().toLowerCase().contains(incomplete.toLowerCase())
            ) {
                return player;
            }
        }
    ...
    public static void playCoinPickupSound(@NotNull Player player) {
    ...
    public static Optional<Player> getRootDamage(@NotNull LivingEntity dead) {
    ...
    public static Optional<Player> getRootDamage(@NotNull EntityDamageByEntityEvent damageEvent) {
